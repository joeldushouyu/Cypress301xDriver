...
#define CY_FX_SLFIFO_DMA_BUF_COUNT_P_2_U      (4)              /* Slave FIFO P_2_U channel buffer count - Used with AUTO DMA channel */
#define CY_FX_SLFIFO_DMA_BUF_COUNT_U_2_P 	  (4)			   /* Slave FIFO U_2_P channel buffer count - Used with AUTO DMA channel */
#endif
